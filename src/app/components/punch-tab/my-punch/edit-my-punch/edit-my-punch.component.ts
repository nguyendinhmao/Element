...
@Component({
  selector: "edit-my-punch",
  styleUrls: ["./edit-my-punch.component.scss"],
  templateUrl: "./edit-my-punch.component.html",
})

export class EditMyPunchComponent implements OnInit {
