...
@Component({
    selector: 'import-tagno',
    templateUrl: './import-tagno.component.html'
})

export class ImportDataTagNoComponent {
    ...
    onImportData = () => {
        if (this.fileDataTagNo) {
            ...
            this.dataTagNoService.insertTagNosViaCsvFile(this.projectKey,this.fileDataTagNo).subscribe({
                complete: () => {
