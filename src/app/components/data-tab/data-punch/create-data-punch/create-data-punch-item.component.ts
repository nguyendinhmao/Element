...
import { KeyLookups, KeyValues } from 'src/app/shared/models/punch-item/punch-item.model';
import { InfoDevice } from 'src/app/shared/models/common/global-variables';

@Component({
  selector: "create-data-punch-item",
  styleUrls: ["./create-data-punch-item.component.scss"],
  templateUrl: "./create-data-punch-item.component.html",
})

export class CreateDataPunchItemComponent implements OnInit {
