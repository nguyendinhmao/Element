...
@Component({
  selector: 'create-jobcard',
  templateUrl: './create-jobcard.component.html'
})
export class CreateJobCardComponent implements OnInit {
  ...
  creationModel: CreateJobCardModel = new CreateJobCardModel();
  ...
  onSaveData = (form: NgForm) => {
    ...
    let jobcardCreateModel = <CreateJobCardModel>{
      ...this.creationModel
    };
    this.dataJobCardService.createJobCard(jobcardCreateModel).subscribe({
      complete: () => {
